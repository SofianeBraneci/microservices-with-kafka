...
public class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, PaymentRequest>>
    factory(ConsumerFactory<String, PaymentRequest> consumerFactory){
